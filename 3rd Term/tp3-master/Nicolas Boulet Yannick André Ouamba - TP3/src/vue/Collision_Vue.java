...
public class Collision_Vue {
	...
	public Collision_Vue(Ctrl pCtrl) throws IOException {
		...
		actions();
		mute_TB.setText("\uD83D\uDD0A");
		mute_TB.setFont(new Font(24));
		couleur_CP.setValue(Data.COULEUR_DEFAUT);
	}
	...
	public Shape addShape() {
		Circle cercle = new Circle((ctrlCol.getList().getListParticules().get(0).getRayon().getValue()),
